...
class Phi():
    ...
    def __init__(self, data, modeling_options, obj, c=1):
        ...
        # Levels
        self.problem.T = pyo.RangeSet(0, int(self.problem.horizon_decision/365))
        self.problem.T_excl_0 = pyo.RangeSet(1, int(self.problem.horizon_decision/365))
        self.problem.T_excl_01 = pyo.RangeSet(2, int(self.problem.horizon_decision/365))
    ...
    def add_shelter_increase_decrease(self, shelter_mode):
        ...
        self.problem.T_shelter_second = pyo.RangeSet(shelter_mode+1, int(self.problem.horizon_decision/365))
...
def budget_constraint(problem):
    costs = 0
    for t in range(int(problem.horizon_decision/365)):
